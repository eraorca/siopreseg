...
#--
#-- Programa:     elmayor.asm [E01]
#--
#-- Autor:        Emiro Reyes Alvarado
#--
#-- Creado:       sábado 30 de marzo de 2024 - 03:36 PM
#--
#-- Modificado:   domingo 31 de marzo de 2024 - 04:25 AM
#--
#-- Función:      Solicita al usuario hasta ('CI_ADT_TAMATAB' + 1 ) números enteros positivos,
#--               calcula el mayor de todos y lo imprime en pantalla.
#--
...
#--                    paso anterior.
#--
#--                    Asume que el primer elemento de la tabla es el mayor.
#--
#--               [6]  Inicia un ciclo que termina cuando llegue al final de la tabla, en el que
#--                    imprime sus elementos y calcula el mayor de todos, de la siguiente manera...
#--
...
#--                           'CS_SPS_SEPARADOR'.
#--
#--                    <6.3>  Si el elemento actual es menor o igual que el mayor actual, no hace
#--                           nada.
#--
#--                           Si es mayor, lo almacena en el mayor actual.
#--
#--               [7]  Imprime el elemento mayor de la tabla.
#--
...
#--                    nuevamente.
#--
#--                    Después recupera el contexto de la ejecución, cuando se generó la excepción,
#--                    y retorna a la instrucción que la generó, para continuar la ejecución
#--                    normal.
#--
#-- Registros:    $t0 ::= Almacena temporalmente el valor del elemento actual de la tabla.  Se
#--                       utiliza cuando se imprime la tabla y cuando se calcula el mayor valor.
#--
...
#--                       lógicas de las instrucciones condicionales del programa.
#--
#--               $t3 ::= Almacena el valor del mayor elemento actual de la tabla.
#--
...
#--                       nuevamente su valor en 1 durante el ciclo que imprime y calcula el mayor
#--                       valor.
#--
...
#--------------------------------------------------------------------------------------------------
      ...
      .eqv CS_MSG_08     "\n"
      .eqv CS_MSG_09     "\nEl mayor elemento de la tabla es : "
...
#--
      ...
      ciclo_tabla:
          beq $s1,  $zero, mayor                    # Termina el ciclo si llegamos al final de la tabla.
          ...
          si_3:                                     # ($t0 <= $t3)
              ble $t0, $t3, fin_si_3                # Si el elemento actual es menor o igual que el
                                                    #+mayor actual, no tenemos un nuevo mayor.
                  move $t3, $t0                     # Tenemos un nuevo mayor actual.
